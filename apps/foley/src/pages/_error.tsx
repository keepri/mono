    ...
    if (statusCode === 404) {
        return (
            <Section className="grid place-content-center gap-4 py-12 xs:min-h-[70vh] min-h-[40vh] bg-ivory dark:bg-black dark:text-white">
                <h1
                    className={`text-9xl max-xs:text-7xl font-bold text-center ${fontLondrinaSketch}`}
                >
                    u lost?
                </h1>
                ...
                <Link button href={URLS.HOME} className="button text-center">
                    go home
                </Link>
            </Section>
        );
        ...
        <Section className="grid place-content-center gap-8 py-12 xs:min-h-[70vh] min-h-[40vh] bg-ivory dark:bg-black dark:text-white">
            ...
            <span>
                <p className="text-lg text-center">
                    <Balancer>encountered an error, sorry about that!</Balancer>
                </p>
