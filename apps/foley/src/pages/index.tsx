        ...
        <>
            <section className="grid place-content-center place-items-center gap-12 min-h-screen bg-gradient-to-b from-[var(--clr-bg-500)] to-[var(--clr-bg-300)]">
                <a
                    ...
                    className={`relative text-[var(--clr-white)] text-center px-4 ${londrinaSketch.variable} font-londrina-sketch leading-none sm:whitespace-nowrap hover:text-[var(--clr-bg-500)] transition-colors duration-100 max-[365px]:max-w-[11rem]`}
                >
