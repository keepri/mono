...
export default function ContactForm(props: Props): JSX.Element {
    ...
    const buttonText = useMemo(() => {
        ...
        console.warn(
            "ContactForm: button text for status -",
            status,
            "- was not handled"
        );
        return "send";
    ...
    return (
        <form
            ...
            className={`${props.className ?? ""} flex flex-col gap-4`}
        >
            <span className="flex flex-wrap justify-between gap-4">
                <Input
                    ...
                    className={`block border ${
                        errorFields?.name ? "border-red-500" : ""
                    } border-gray-300 placeholder-gray-400 bg-white dark:bg-black focus:outline-[var(--clr-orange)] focus:outline-dotted focus:outline-2`}
                    labelClass="flex-1"
            ...
            <span className="flex flex-col gap-2">
                <Textarea
                    ...
                    className={`resize-none border ${
                        errorFields?.message ? "border-red-500" : ""
                    } border-gray-300 placeholder-gray-400 bg-white dark:bg-black focus:outline-[var(--clr-orange)] focus:outline-dotted focus:outline-2`}
            ...
            <Button
                ...
                className={`${
                    status === Status.error
                        ...
                        : ""
                } button !py-3 mt-4 border-gray-400 bg-white dark:bg-black`}
            >
                {buttonText}
            </Button>
        </form>
