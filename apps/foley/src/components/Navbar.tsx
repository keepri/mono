...
export default function Navbar(): JSX.Element {
    ...
    return (
        <nav
            className={`${fontInconsolata} sticky top-0 flex items-center py-2 bg-ivory dark:bg-black z-10`}
        >
...
function Logo(): JSX.Element {
    return (
        <Link href={URLS.HOME}>
            <h1
                className={`text-6xl leading-none dark:text-white hover:!text-[var(--clr-orange)] ${fontLondrinaSketch}`}
            >
                K
            </h1>
        </Link>
