        ...
        <>
            <span className={`flex flex-col ${isSignedIn ? "gap-[.27rem]" : "gap-1"}`}>
                ...
                <span className="group flex items-center justify-end gap-2">
                    <div className={`${isSignedIn || loading ? "hidden" : ""} flex gap-2 items-center justify-evenly group-hover:scale-100 scale-0 group-hover:opacity-100 opacity-0 transition-transform`}>
